![header](https://capsule-render.vercel.app/api?type=waving&color=E02826&height=300&section=header&text=Hello%20World,%20I'm%20Songarden!&fontSize=45&fondColor=auto&animation=fadeIn&fontAlignY=38&descAlignY=51&descAlign=62)
...
<div>
  ...
  <img src="https://img.shields.io/badge/Redmine-B32024?style=plastic&logo=ruby&logoColor=white">
</div>
...
### 🏢 피플아이 (people-i.co.kr) | 소프트웨어개발자
`2026.01 ~ 현재`

- WPF(C#) 데스크탑 클라이언트 설계 및 DevExpress MVVM 패턴 적용
- Node.js / Express 백엔드 API 서버 구축 (JWT 인증 포함)
...
- Android 기반 산업용 PDA 디바이스 WLAN 통신 시스템 포팅
- Kernel 영역 WLAN 드라이버 → 펌웨어 전달 포팅 및 User 영역 Service 계층 인터페이스 연동
- WLAN Config Overlay Module 설계 및 Custom Config 기능 제공 S/W 개발

### 🏢 쎄트렉아이 | 인턴
`2024.04 ~ 2024.07` `3개월`

- 위성 서브시스템 소프트웨어 설계 (Flow Diagram / ERD / Class Diagram)
- Java Spring 기반 위성 서브시스템 모니터링 RESTful API 구현
- 단위 테스트 코드 작성 및 모니터링 인터페이스 F/E 구현
- Jira / Confluence / Git 활용
...
| 기간 | 내용 |
|------|------|
| 2018 ~ 2023 | 충남대학교 전자공학과 졸업 (학점 3.53/4.5) |
| 2023.10 ~ 2024.02 | 크래프톤 정글 3기 — CS 이론, malloc Lab, RB트리, 핀토스, 팀 프로젝트 |
| 2023.01 ~ 2023.05 | CNU SW 아카데미 2기 — Java/Spring 백엔드, TenQuest 서비스 배포 |

---

## 🏆 Awards & Certifications

- 🥉 2023 CNU SW 아카데미 최종 발표회 **동상**
- 🏅 충남대학교 총장 **표창장** (공과대학 엔지니어링 페어 총괄, EE데이 기획)
- 🥇 2022 CNU EE데이 캡스톤디자인 경진대회 **최우수상**
- 📜 정보처리기사 (2025.06)
- 📜 한국사능력검정시험 1급 (2021.02)
- 🗣️ OPIc 영어 **IH** (2023.07)

<br>

![songarden's github stats](https://github-readme-stats-sigma-five.vercel.app/api?username=songarden&show_icons=true&theme=radical)
